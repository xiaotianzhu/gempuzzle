...
Game::Game(int nrow, int ncol){
    ...
    int choice;
    for(;;){
        std::cout << std::endl << "Initialize Game: 1. Randomly; 2. By User." << std::endl;
...
int Game::SolveIt() {
    ...
    int bound = root.H;
    int t;
    std::cout << std::endl << "I am thinking ...";
	std::cout << std::endl << "May take up to a couple of mins on most computers ..." << std::endl;
...
void Game::Display() const{
    ...
    std::cout << std::endl << "Move History (total of " << MoveHistory.size() << " steps):" << std::endl;
